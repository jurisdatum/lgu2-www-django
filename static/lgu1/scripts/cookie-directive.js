...
$(function () {
    ...
    if (!window.legGlobals.cookiePolicy.userSet) {
        $('body').append('<img src="/static/lgu1/images/analytics/cookiesBannerIgnored.gif" alt="" />');
    } else if (!window.legGlobals.cookiePolicy.analytics) {
        $('body').append('<img src="/static/lgu1/images/analytics/cookiesForAnalyticsRejected.gif" alt="" />');
    }
