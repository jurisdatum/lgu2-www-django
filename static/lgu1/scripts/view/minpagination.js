...
$.fn.miniPagination = function(miniPaginationOptions){
	...
	$(this).each(function () {
		...
		$container.append('<ul id="miniPageNav"><li id="miniPageNavPrev"><a href="#"><img src="/static/lgu1/images/chrome/miniNavPrev_default.gif" alt="Prev" class="userFeedbackImg" /></a></li><li id="miniPageNavCurrent">XXX</li><li id="miniPageNavNext"><a href="#"><img src="/static/lgu1/images/chrome/miniNavNext_default.gif" alt="Prev" class="userFeedbackImg" /></a></li></ul>');
		...
		if (option.firstPageLink) {
			$miniPageNav.prepend('<li id="miniPageNavFirst"><a href="#"><img src="/static/lgu1/images/chrome/miniNavFirst_default.gif" alt="First" class="userFeedbackImg" /></a></li>');
			$linkFirst = $("#miniPageNavFirst a");
		}
		
		if (option.lastPageLink) {
			$miniPageNav.append('<li id="miniPageNavLast"><a href="#"><img src="/static/lgu1/images/chrome/miniNavLast_default.gif" alt="Last" class="userFeedbackImg" /></a></li>');
