...
$(function () {
	...
	var RECRUITMENT_URL = "https://www.civilservicejobs.service.gov.uk/csr/jobs.cgi?jcode=1916786";
	var Job_Message = "If you’d like to join the legislation.gov.uk team, we’re currently recruiting for a Senior Delivery Manager and a Support Analyst to work on our legislative drafting tool - Lawmaker.";
...
$.fn.legInterfaceOptions = function() {
	...
	this.each(function () {
		...
		$("<a/>")
		.attr("href", "#")
		.html('<img src="/static/lgu1/images/chrome/closeIcon.gif" alt="Close" />')
		.addClass("closeLink")
		.prependTo(intOption)
		.click(function(e) {
	...
	$(this).each(function () {
		...
		$(this).click(function(event){	
				...
				if (option.type == 'defaultWin'){
					...
					.prepend('<a href="#" class="closeLink"><img src="/static/lgu1/images/chrome/closeIcon.gif" alt="Close"/></a>')
...
$(function () {
    ...
    function checkForChanges() {
        ...
        var $img = $('<img alt="" />');
        $img.attr('src', '/static/lgu1/images/analytics/' + status + '.gif');
        $img.appendTo('body');
