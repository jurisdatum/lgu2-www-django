...
from .views.browse import browse, browse_uk
...
urlpatterns += i18n_patterns(
    ...
    path('browse/uk', browse_uk, name='browse-uk'),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)$', browse, name='browse'),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})$', browse, name='browse-year'),

    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)$', document, name='document'),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/data\.xml$', document_clml),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/data\.akn$', document_akn),

    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/(?P<version>enacted|made|\d{4}-\d{2}-\d{2})$', document, name='document-version'),
    ...
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/(?P<section>[A-Za-z0-9/-]+)/(?P<version>enacted|made|\d{4}-\d{2}-\d{2})$', fragment.fragment, name='fragment'),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/(?P<section>[A-Za-z0-9/-]+)/(?P<version>enacted|made|\d{4}-\d{2}-\d{2})/data\.(?P<format>xml|akn)$', fragment.data),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/(?P<section>[A-Za-z0-9/-]+)$', fragment.fragment),
    re_path(r'^(?P<type>ukpga|uksi|wsi|nisi)/(?P<year>[0-9]{4})/(?P<number>[0-9]+)/(?P<section>[A-Za-z0-9/-]+)/data\.(?P<format>xml|akn)$', fragment.data),
